...
2. use the actual path to the file (e.g., "/Users/Kim/Documents/mydata.xlsx"), 
...
1. print the imported dataframe or use **view()**, 
2. **colnames()**, 
3. **head()** or **tail()**, 
4. **str()**
...
One of the listed functions “mean” looks promising. Your next step might be to get more information by typing *help(mean)* or *?mean* or *example(mean)*. 
