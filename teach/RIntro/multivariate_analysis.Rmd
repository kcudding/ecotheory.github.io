...
1. Understand the interactions and relationships among multiple variables. Visualize the results in a lower-dimensional space, such as a two-dimensional or three-dimensional plot, while preserving the overall structure of the data.
...
### Extract samples and variables in new ordination system
...
ordiplot(pca.ham, type = "n", main = "Individuals ('sites')",
         xlab = paste0("PC1 (50.92%)"), 
         ylab = paste0("PC2 (20.60%)"), 
         ylim = c(-1.5,1.5))
