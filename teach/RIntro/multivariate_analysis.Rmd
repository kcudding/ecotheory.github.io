...
Meanwhile, we can also look at the proportional variance explained by each principle component. Recall that such information is available in the **`summary()`** of our PCA results. We see the first two PCs together explain roughly 77% of the total variance in this dataset. Along with the screeplot, we are confident that the first two PC are sufficient enough to represent our data.
