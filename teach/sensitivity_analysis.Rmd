...
```{r echo=FALSE}
Juvenile_survival<-c(0.67,0.05)
Adult_reproduction<-c(0.06,0.49)

Combined<-cbind(Juvenile_survival,Adult_reproduction)
barplot(Combined,beside=TRUE,yaxt="n", cex.lab=1.2, las=1, lwd=1.5)
legend("topright", c("Sensivities", "Elasticities"),pch = 15,
       col=c("black", "grey"))
```
